...
export default function MovieDetails() {
    ...
    useEffect(() => {
        ...
        async function getMovieDetails() {
            let { data } = await axios.get(`https://api.themoviedb.org/3/movie/${id}?api_key=c5b0900679a368108998cadec9a4f607&language=en-US`);
            console.log(data);
        ...
        <div className="container">
            ...
            <div className="row p-5">
                ...
                <div className="col-md-4">
                    <div>
                        <img src={`https://image.tmdb.org/t/p/original/${moviedetails.poster_path}`} alt="movie poster" className='w-100' />
                    </div>
                </div>
                ...
                <div className="col-md-8">
                    <div className='text-light'>
                        ...
                        <h4 className='text-muted'>{moviedetails.tagline}</h4>
